...
def _has_truncated_ellipsis(text: str) -> bool:
    # Three-dot ellipses are generated by our truncation helpers. A Unicode
    # ellipsis can be part of a real paper title, for example AGI Is Coming…
    # Right After AI Learns to Play Wordle, so only flag it at the end.
    return bool(re.search(r"\.\.\.\s*$|…\s*$|\.\.\.\s+[A-Z0-9]", text or ""))
