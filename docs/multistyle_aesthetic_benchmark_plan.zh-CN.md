...
- golden0/1/2 layout grammar；
- 从三套 golden reference 提取出的成熟页面模板。
...
- 人工反馈转 rule 的比例；
- native editability / source traceability / human correction cost；
- 三套 frozen references 是否被 style-specific rules 误伤。
